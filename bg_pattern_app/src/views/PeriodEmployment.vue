  ...
  <div class="p-4">
    ...
    >
      <div v-if="selectedRow" class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
          ...
          <div class="bg-gray-50 p-3 rounded">
            ...
            <div class="font-medium">{{ formatTableDate(selectedRow.date) }}</div>
          </div>
          ...
          <div class="bg-gray-50 p-3 rounded">
            ...
            <div class="font-medium">{{ selectedRow.result }}%</div>
          </div>
        </div>
      ...
      <template #footer>
        ...
        />
        <Button 
          v-if="selectedRow && selectedRow.userId"
          label="Все задачи сотрудника" 
          icon="pi pi-user" 
          @click="viewEmployeeTasks"
          autofocus 
        />
      </template>
    </Dialog>
    ...
    if (startDate.value && endDate.value) {
      ...
      while (currentDate <= end) {
        const sortedUsers = users.value
          ...
          .map(user=>user.toTableRow(currentDate, workingHours.value))
