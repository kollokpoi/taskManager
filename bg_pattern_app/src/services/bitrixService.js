  ...
  async createPlannedTimeField() {
    try {
      const fieldData = {
        ...
        EDIT_IN_LIST: 'Y',
        IS_SEARCHABLE: 'N',
        EDIT_FORM_LABEL: { ru: 'Планируемое время (ч)', en: 'Planned time (hours)' },
        LIST_COLUMN_LABEL: { ru: 'Планируемое время (ч)', en: 'Planned time (hours)' },
        LIST_FILTER_LABEL: { ru: 'Планируемое время (ч)', en: 'Planned time (hours)' },
        SETTINGS: { SIZE: 20, MIN_LENGTH: 0, MAX_LENGTH: 255, DEFAULT_VALUE: '' }
      };
